...
declare const TooltipContainer: _stitches_react_types_styled_component.StyledComponent<"div", {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        brown: string;
...
declare function Tooltip({ date, available, ...props }: TooltipProps): react_jsx_runtime.JSX.Element;
...
declare const theme: string & {
    ...
    colors: {
        ...
        brown: _stitches_react_types_theme.Token<"brown", string, "colors", "">;
...
declare const createTheme: <Argument0 extends string | ({
    colors?: {
        ...
        brown?: string | number | boolean | undefined;
